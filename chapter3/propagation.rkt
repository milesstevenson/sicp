...
(define (for-each-except exception procedure list)
  ;; Iterator which applies a designated procedure to all items in a list except
  ;; a given one.
  (define (loop items)
...
(define (adder a1 a2 sum)
  ;; Adder connects to the new adder to the designated connectors and returns
  ;; it as its value. The procedure me, which represents the adder, acts as a
  ;; dispatch to the local procedures.
  (define (process-new-value)
